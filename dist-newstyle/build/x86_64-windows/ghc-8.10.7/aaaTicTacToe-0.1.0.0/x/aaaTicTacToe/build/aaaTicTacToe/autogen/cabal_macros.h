...
/* package aaaTicTacToe-0.1.0.0 */
#ifndef VERSION_aaaTicTacToe
#define VERSION_aaaTicTacToe "0.1.0.0"
#endif /* VERSION_aaaTicTacToe */
#ifndef MIN_VERSION_aaaTicTacToe
#define MIN_VERSION_aaaTicTacToe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_aaaTicTacToe */
...
#define CURRENT_COMPONENT_ID "aaaTicTacToe-0.1.0.0-inplace-aaaTicTacToe"
